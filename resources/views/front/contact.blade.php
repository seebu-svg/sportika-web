            ...
            <div class="lg:col-span-3">
                ...
                >
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            <label for="name" class="mb-1.5 block text-xs font-bold uppercase tracking-wider text-gray-400">Name</label>
                            <input
                                type="text"
                                id="name"
                                name="name"
                                value="{{ old('name') }}"
                                required
                                class="w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm text-black placeholder-gray-400 outline-none focus:border-accent-400 @error('name') border-red-500/60 @enderror"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('email') }}"
                                required
                                class="w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm text-black placeholder-gray-400 outline-none focus:border-accent-400 @error('email') border-red-500/60 @enderror"
                            >
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            <label for="phone" class="mb-1.5 block text-xs font-bold uppercase tracking-wider text-gray-400">Phone <span class="text-gray-700">(optional)</span></label>
                            <input
                                type="tel"
                                id="phone"
                                name="phone"
                                value="{{ old('phone') }}"
                                class="w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm text-black placeholder-gray-400 outline-none focus:border-accent-400 @error('phone') border-red-500/60 @enderror"
                            >
                            @error('phone') <p class="mt-1 text-xs text-red-400">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label for="subject" class="mb-1.5 block text-xs font-bold uppercase tracking-wider text-gray-400">Subject</label>
                            <input
                                type="text"
                                id="subject"
                                name="subject"
                                value="{{ old('subject') }}"
                                required
                                class="w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm text-black placeholder-gray-400 outline-none focus:border-accent-400 @error('subject') border-red-500/60 @enderror"
                            >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="6"
                            required
                            class="w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm text-black placeholder-gray-400 outline-none focus:border-accent-400 @error('message') border-red-500/60 @enderror"
                    ...
                    <button
                        type="submit"
                        class="w-full rounded-full bg-accent-500 px-6 py-3.5 text-sm font-bold uppercase tracking-wider text-white transition hover:bg-accent-400 sm:w-auto"
                    >
                        Send message
                    </button>
                </form>
                    ...
                    <ul class="mt-4 space-y-4 text-sm text-gray-400">
                        @if ($settings->email)
                            <li class="flex items-start gap-3">
                                <span class="grid size-9 shrink-0 place-items-center rounded-full bg-accent-500/15 text-accent-500">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:{{ $settings->email }}" class="text-black hover:text-accent-400">{{ $settings->email }}</a>
                                </div>
                            </li>
                        @endif
                        @if ($settings->phone)
                            <li class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="tel:{{ preg_replace('/[^\d+]/', '', $settings->phone) }}" class="text-black hover:text-accent-400">{{ $settings->phone }}</a>
                                </div>
                            </li>
                        @endif
                        @if ($settings->address)
                            <li class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="text-xs uppercase tracking-wider text-gray-400">Office</p>
                                    <p class="text-black">{{ $settings->address }}</p>
                                </div>
                            </li>
                        @endif
                    </ul>
                ...
                <div class="card-shadow rounded-2xl border border-gray-200 bg-white p-6">
                    ...
                    <div class="mt-4 flex flex-wrap gap-2">
                        @if ($settings->facebook_url)
                            <a href="{{ $settings->facebook_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-sm text-gray-700 transition hover:border-blue-500/50 hover:text-accent-300">
                        ...
                        @if ($settings->instagram_url)
                            <a href="{{ $settings->instagram_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-sm text-gray-700 transition hover:border-pink-500/50 hover:text-pink-400">
                        ...
                        @if ($settings->twitter_url)
                            <a href="{{ $settings->twitter_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-sm text-gray-700 transition hover:border-sky-500/50 hover:text-sky-400">
                        ...
                        @if ($settings->youtube_url)
                            <a href="{{ $settings->youtube_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-sm text-gray-700 transition hover:border-red-500/50 hover:text-red-400">
                        ...
                        @if ($settings->linkedin_url)
                            <a href="{{ $settings->linkedin_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-sm text-gray-700 transition hover:border-accent-500/50 hover:text-accent-400">
