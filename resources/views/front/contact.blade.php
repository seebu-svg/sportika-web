        ...
        <div class="grid gap-10 lg:grid-cols-5">
            ...
            <div class="lg:col-span-3">
                ...
                <form
                    ...
                    method="POST"
                    class="space-y-5 rounded-2xl border border-slate-200 bg-white p-6 sm:p-8"
                >
                    @csrf
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('name') }}"
                                required
                                class="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm text-pitch-950 placeholder-slate-500 outline-none focus:border-blue-400 @error('name') border-red-500/60 @enderror"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('email') }}"
                                required
                                class="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm text-pitch-950 placeholder-slate-500 outline-none focus:border-blue-400 @error('email') border-red-500/60 @enderror"
                            >
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                name="phone"
                                value="{{ old('phone') }}"
                                class="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm text-pitch-950 placeholder-slate-500 outline-none focus:border-blue-400 @error('phone') border-red-500/60 @enderror"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('subject') }}"
                                required
                                class="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm text-pitch-950 placeholder-slate-500 outline-none focus:border-blue-400 @error('subject') border-red-500/60 @enderror"
                            >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="6"
                            required
                            class="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm text-pitch-950 placeholder-slate-500 outline-none focus:border-blue-400 @error('message') border-red-500/60 @enderror"
                    ...
                    <button
                        type="submit"
                        class="w-full rounded-full bg-blue-600 px-6 py-3.5 text-sm font-bold uppercase tracking-wider text-white transition hover:bg-blue-500 sm:w-auto"
                    >
                        Send message
                    </button>
                </form>
            ...
            <aside class="space-y-6 lg:col-span-2">
                    ...
                    <ul class="mt-4 space-y-4 text-sm text-slate-400">
                        @if ($settings->email)
                            <li class="flex items-start gap-3">
                                <span class="grid size-9 shrink-0 place-items-center rounded-full bg-blue-600/15 text-blue-600">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:{{ $settings->email }}" class="text-pitch-950 hover:text-blue-500">{{ $settings->email }}</a>
                                </div>
                            </li>
                        @endif
                        @if ($settings->phone)
                            <li class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="tel:{{ preg_replace('/[^\d+]/', '', $settings->phone) }}" class="text-pitch-950 hover:text-blue-500">{{ $settings->phone }}</a>
                                </div>
                            </li>
                        @endif
                        @if ($settings->address)
                            <li class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="text-xs uppercase tracking-wider text-slate-400">Office</p>
                                    <p class="text-pitch-950">{{ $settings->address }}</p>
                                </div>
                            </li>
                        @endif
                    </ul>
                ...
                <div class="rounded-2xl border border-blue-200 bg-white p-6">
                    <h3 class="font-display text-xl tracking-wider text-white">Response time</h3>
                    <p class="mt-3 text-sm leading-relaxed text-slate-400">
                        We typically respond within <strong class="text-pitch-950">24 hours</strong> on business days. Urgent enquiries about active transfers should include <strong class="text-blue-500">"URGENT"</strong> in the subject line.
                    </p>
                </div>
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-6">
                    ...
                    <div class="mt-4 flex flex-wrap gap-2">
                        @if ($settings->facebook_url)
                            <a href="{{ $settings->facebook_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm text-slate-600 transition hover:border-blue-500/50 hover:text-blue-400">
                        ...
                        @if ($settings->instagram_url)
                            <a href="{{ $settings->instagram_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm text-slate-600 transition hover:border-pink-500/50 hover:text-pink-400">
                        ...
                        @if ($settings->twitter_url)
                            <a href="{{ $settings->twitter_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm text-slate-600 transition hover:border-sky-500/50 hover:text-sky-400">
                        ...
                        @if ($settings->youtube_url)
                            <a href="{{ $settings->youtube_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm text-slate-600 transition hover:border-red-500/50 hover:text-red-400">
                        ...
                        @if ($settings->linkedin_url)
                            <a href="{{ $settings->linkedin_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm text-slate-600 transition hover:border-blue-600/50 hover:text-blue-500">
