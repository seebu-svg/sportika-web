    ...
    <section class="relative overflow-hidden bg-pitch-900">
        ...
        <div class="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
            <nav class="mb-6 text-sm text-slate-400">
                ...
                <a href="{{ route('team') }}" class="hover:text-accent-300">Team</a>
                <span class="mx-2 text-slate-600">/</span>
            ...
            <div class="grid items-start gap-10 lg:grid-cols-3">
                <div class="lg:col-span-1">
                    <div class="mx-auto aspect-[3/4] max-w-sm overflow-hidden rounded-3xl border border-white/10 bg-pitch-800">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mt-8 flex flex-wrap gap-3">
                        @if ($member->email)
                            <a href="mailto:{{ $member->email }}" class="rounded-full border border-white/20 px-5 py-2.5 text-sm font-bold uppercase tracking-wider text-white transition hover:border-accent-400/60 hover:text-accent-300">
                                Email {{ Str::before($member->name, ' ') }}
                            </a>
                        @endif
                        <a href="{{ route('contact') }}" class="rounded-full bg-accent-400 px-5 py-2.5 text-sm font-bold uppercase tracking-wider text-pitch-950 transition hover:bg-accent-300">
                            Contact us
                        </a>
                    </div>
