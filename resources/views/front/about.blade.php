...
@section('content')
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="grid gap-12 lg:grid-cols-2">
            <div>
                <p class="mb-2 text-xs font-bold uppercase tracking-[0.25em] text-blue-600">Our Story</p>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="rounded-2xl border border-slate-200 bg-white p-7">
                    <p class="font-display text-5xl text-blue-600">{{ $playerCount }}</p>
                    <p class="mt-1 text-sm text-slate-400">Players represented</p>
                </div>
                <div class="rounded-2xl border border-slate-200 bg-white p-7 mt-6">
                    <p class="font-display text-5xl text-blue-600">{{ $postCount }}</p>
                    <p class="mt-1 text-sm text-slate-400">News articles published</p>
                </div>
                <div class="rounded-2xl border border-slate-200 bg-white p-7">
                    <p class="font-display text-5xl text-blue-600">24</p>
                    <p class="mt-1 text-sm text-slate-400">Tournaments organized</p>
                </div>
                <div class="rounded-2xl border border-slate-200 bg-white p-7 mt-6">
                    <p class="font-display text-5xl text-blue-600">15+</p>
        ...
        <div class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
            <div class="grid gap-8 md:grid-cols-2">
                <div class="rounded-2xl border border-slate-200 bg-white p-8">
                    <div class="mb-4 grid size-12 place-items-center rounded-xl bg-blue-600/15 text-blue-600">
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div class="relative mx-auto max-w-3xl">
            <div class="absolute left-4 top-0 bottom-0 w-px bg-blue-600/20 md:left-1/2"></div>
            @foreach ([
                ...
                <div class="relative mb-10 pl-12 md:pl-0 @if($i % 2 === 0) md:pr-[52%] md:text-right @else md:pl-[52%] @endif">
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white p-5">
                        <span class="font-display text-2xl text-blue-600">{{ $milestone['year'] }}</span>
                        <h4 class="mt-1 text-lg font-semibold text-pitch-950">{{ $milestone['title'] }}</h4>
            ...
            <div class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
                ...
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    @foreach ($teamMembers as $member)
                        <a href="{{ route('team.show', $member->slug) }}" class="group rounded-2xl border border-slate-200 bg-white p-6 text-center transition hover:-translate-y-1 hover:border-blue-300">
                            <div class="mx-auto mb-4 size-24 overflow-hidden rounded-full border-2 border-blue-400/20 bg-pitch-700">
                            ...
                            <p class="mt-1 text-sm text-blue-600">{{ $member->designation }}</p>
                        </a>
                    @endforeach
                </div>
                <div class="mt-10 text-center">
                    <a href="{{ route('team') }}" class="rounded-full border border-blue-300 px-6 py-3 text-sm font-bold uppercase tracking-wider text-blue-500 transition hover:bg-blue-600/10">
                        View full team →
                    </a>
                </div>
            </div>
    ...
    {{-- =========================== CTA ================================ --}}
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="relative overflow-hidden rounded-3xl border border-blue-400/20 bg-gradient-to-br from-pitch-800 to-pitch-900 px-8 py-16 text-center sm:px-16">
            <div class="bg-diagonal absolute inset-0"></div>
            <div class="relative">
                ...
                <div class="mt-10 flex flex-wrap justify-center gap-4">
                    <a href="{{ route('contact') }}" class="rounded-full bg-blue-600 px-8 py-4 text-sm font-bold uppercase tracking-wider text-pitch-950 transition hover:bg-blue-500">
                        Contact Us
                    </a>
                    <a href="{{ route('membership.player') }}" class="rounded-full border border-white/20 px-8 py-4 text-sm font-bold uppercase tracking-wider text-pitch-950 transition hover:border-blue-400 hover:text-blue-500">
                        Join as Player
                    </a>
                </div>
            </div>
