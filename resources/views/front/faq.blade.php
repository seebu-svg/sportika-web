...
@section('content')
    ...
    <section class="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8" x-data="{ open: null }">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-slate-200 bg-white overflow-hidden">
                    <button
                        ...
                        class="flex w-full items-center justify-between px-6 py-4 text-left text-pitch-950 transition hover:bg-blue-50"
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-blue-600 transition-transform" :class="{ 'rotate-180': open === {{ $i }} }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
                    <div x-show="open === {{ $i }}" x-collapse>
                        <div class="px-6 pb-5 text-sm leading-relaxed text-slate-400">{{ $faq['a'] }}</div>
                    </div>
                </div>
            @endforeach
        </div>
        ...
        <div class="mb-12 space-y-3">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-slate-200 bg-white overflow-hidden">
                    ...
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-blue-600 transition-transform" :class="{ 'rotate-180': open === 'p{{ $i }}' }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
        ...
        <div class="mb-12 space-y-3">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-slate-200 bg-white overflow-hidden">
                    ...
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-blue-600 transition-transform" :class="{ 'rotate-180': open === 't{{ $i }}' }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
        ...
        <div class="mb-12 space-y-3">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-slate-200 bg-white overflow-hidden">
                    ...
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-blue-600 transition-transform" :class="{ 'rotate-180': open === 's{{ $i }}' }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
        ...
        <div class="mb-12 space-y-3">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-slate-200 bg-white overflow-hidden">
                    ...
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-blue-600 transition-transform" :class="{ 'rotate-180': open === 'pc{{ $i }}' }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
        ...
        <div class="mt-8 rounded-2xl border border-blue-200 bg-white p-8 text-center">
            <h3 class="font-display text-2xl tracking-wider text-white">Still have questions?</h3>
            <p class="mt-3 text-sm leading-relaxed text-slate-400">Can't find what you're looking for? Our team is happy to help.</p>
            <div class="mt-6 flex flex-wrap justify-center gap-3">
                ...
                <a href="mailto:{{ $settings->email }}" class="rounded-full border border-white/20 px-6 py-3 text-sm font-bold uppercase tracking-wider text-pitch-950 transition hover:border-blue-400 hover:text-blue-500">
                    Email us
                </a>
            </div>
        </div>
