    ...
    <section class="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8" x-data="{ open: null }">
        ...
        <div class="mb-12 space-y-3">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-white/10 bg-pitch-800 overflow-hidden">
                    <button
                        @click="open === {{ $i }} ? open = null : open = {{ $i }}"
                        class="flex w-full items-center justify-between px-6 py-4 text-left text-white transition hover:bg-white/5"
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-accent-400 transition-transform" :class="{ 'rotate-180': open === {{ $i }} }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
        ...
        <div class="mb-12 space-y-3">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-white/10 bg-pitch-800 overflow-hidden">
                    ...
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-accent-400 transition-transform" :class="{ 'rotate-180': open === 'p{{ $i }}' }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
        ...
        <div class="mb-12 space-y-3">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-white/10 bg-pitch-800 overflow-hidden">
                    ...
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-accent-400 transition-transform" :class="{ 'rotate-180': open === 't{{ $i }}' }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
        ...
        <div class="mb-12 space-y-3">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-white/10 bg-pitch-800 overflow-hidden">
                    ...
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-accent-400 transition-transform" :class="{ 'rotate-180': open === 's{{ $i }}' }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
        ...
        <div class="mb-12 space-y-3">
            ...
            @foreach ($faqs as $i => $faq)
                <div class="rounded-xl border border-white/10 bg-pitch-800 overflow-hidden">
                    ...
                    >
                        <span class="pr-4 font-medium">{{ $faq['q'] }}</span>
                        <svg class="size-5 shrink-0 text-accent-400 transition-transform" :class="{ 'rotate-180': open === 'pc{{ $i }}' }" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5"/></svg>
                    </button>
        ...
        <div class="mt-8 rounded-2xl border border-accent-400/30 bg-pitch-800 p-8 text-center">
            ...
            <div class="mt-6 flex flex-wrap justify-center gap-3">
                ...
                <a href="mailto:{{ $settings->email }}" class="rounded-full border border-white/20 px-6 py-3 text-sm font-bold uppercase tracking-wider text-white transition hover:border-accent-400/60 hover:text-accent-300">
                    Email us
                </a>
            </div>
        </div>
