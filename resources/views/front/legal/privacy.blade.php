...
@section('content')
    ...
    <section class="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
        <div class="prose-custom space-y-10 text-sm leading-relaxed text-slate-400">
            ...
            <div>
                <h2 class="mb-3 font-display text-xl uppercase tracking-wider text-white">1. Introduction</h2>
            ...
            <div>
                ...
                <h3 class="mb-2 text-base font-semibold text-white">2.1 Personal Information</h3>
                ...
                <h3 class="mt-4 mb-2 text-base font-semibold text-white">2.2 Registration Data</h3>
                ...
                <h3 class="mt-4 mb-2 text-base font-semibold text-white">2.3 Contact & Communication Data</h3>
                ...
                <h3 class="mt-4 mb-2 text-base font-semibold text-white">2.4 Technical Data</h3>
            ...
            <div>
                <h2 class="mb-3 font-display text-xl uppercase tracking-wider text-white">3. How We Use Your Information</h2>
            ...
            <div>
                ...
                <ul class="mt-2 list-inside list-disc space-y-1">
                    <li><strong class="text-white">Player Profiles:</strong> Approved player information is displayed publicly on the Sportika platform. Sensitive data (CNIC, phone number) is never shown publicly.</li>
                    <li><strong class="text-white">Service Providers:</strong> We may share data with third-party service providers who assist in operating our website (hosting, email delivery, analytics).</li>
                    <li><strong class="text-white">Sponsors & Organisers:</strong> With your consent, we may share player profiles with sponsors or tournament organisers for legitimate opportunities.</li>
                    <li><strong class="text-white">Legal Requirements:</strong> We may disclose data if required by law, regulation, or legal proceedings.</li>
                    <li><strong class="text-white">Business Transfers:</strong> In the event of a merger, acquisition, or sale of assets, your data may be transferred to the successor entity.</li>
                </ul>
            </div>

            <div>
                <h2 class="mb-3 font-display text-xl uppercase tracking-wider text-white">5. Data Retention</h2>
            ...
            <div>
                ...
                <ul class="mt-2 list-inside list-disc space-y-1">
                    ...
                    <li><strong class="text-white">Correction:</strong> Request correction of inaccurate or incomplete data.</li>
                    <li><strong class="text-white">Deletion:</strong> Request deletion of your personal data, subject to legal requirements.</li>
                    <li><strong class="text-white">Objection:</strong> Object to certain uses of your data, such as marketing communications.</li>
                    <li><strong class="text-white">Portability:</strong> Request transfer of your data to another service.</li>
                    <li><strong class="text-white">Withdrawal of Consent:</strong> Where processing is based on consent, you may withdraw it at any time.</li>
                </ul>
                <p class="mt-2">To exercise any of these rights, please contact us at the email address listed on our website.</p>
            </div>

            <div>
                <h2 class="mb-3 font-display text-xl uppercase tracking-wider text-white">7. Data Security</h2>
            ...
            <div>
                <h2 class="mb-3 font-display text-xl uppercase tracking-wider text-white">8. Cookies</h2>
            ...
            <div>
                <h2 class="mb-3 font-display text-xl uppercase tracking-wider text-white">9. Children's Privacy</h2>
            ...
            <div>
                <h2 class="mb-3 font-display text-xl uppercase tracking-wider text-white">10. Changes to This Policy</h2>
