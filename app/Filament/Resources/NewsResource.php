...
class NewsResource extends Resource
{
                ...
                Section::make('Article')
                    ...
                    ->schema([
                        ...
                        Toggle::make('is_featured')
                            ->helperText('Featured news articles are highlighted on the home page.'),
                    ]),
    ...
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query) => $query->where('post_type', 'news'))
            ->columns([
    ...
    {
        return parent::getEloquentQuery()->where('post_type', 'news');
    }
}
